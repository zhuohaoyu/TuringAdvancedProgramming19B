...
虽然这次作业，只要求上交代码和运行结果，但是老师在讲解说明时，我有很多具体的概念理解的并不深入，于是决定重新学习一次，并记录下学习的过程，包括中途涉及到的参考资料，以便之后参考。如果想直接看最终程序和运行结果，请跳转[这里](#最终代码&运行结果)。所有涉及的文件均已上传至[这个GitHub仓库](https://github.com/zhuohaoyu/TuringAdvancedProgramming19B)。
